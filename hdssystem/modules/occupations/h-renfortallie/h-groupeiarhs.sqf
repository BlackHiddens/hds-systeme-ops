...
{
_LeGroupeOperation = [([getpos _caller,50,100,1,0,60,0] call BIS_fnc_findSafePos),CampsRenfortAllie,(configfile >> "CfgGroups" >> "west" >> "rhs_faction_usarmy_d" >> "rhs_group_nato_usarmy_d_infantry" >> "rhs_group_nato_usarmy_d_infantry_team")] call BIS_fnc_spawnGroup;
