...
for "_i" from 1 to 8 do {(_this select 0) addItemToVest "20Rnd_762x51_Mag";};
(_this select 0) addHeadgear "BoonieH_CCE_U";
(_this select 0) addGoggles "G_Tactical_Clear";


(_this select 0) addWeapon "srifle_DMR_06_olive_F";
(_this select 0) addPrimaryWeaponItem "optic_AMS";
(_this select 0) addPrimaryWeaponItem "bipod_02_F_blk";
