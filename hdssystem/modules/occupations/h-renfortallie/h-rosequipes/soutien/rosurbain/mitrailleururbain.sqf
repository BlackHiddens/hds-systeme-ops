...
(_this select 0) addVest "AAFVest01_m_black";
...
(_this select 0) addItemToVest "rhs_mag_30Rnd_556x45_Mk318_Stanag";
...
(_this select 0) addPrimaryWeaponItem "SMA_ANPEQ15_BLK";
