...
(_this select 0) addBackpack "B_AssaultPack_cbr";
...
(_this select 0) addPrimaryWeaponItem "rhsusf_acc_anpeq15";
(_this select 0) addPrimaryWeaponItem "rhsusf_acc_eotech_552_d";
(_this select 0) addPrimaryWeaponItem "rhsusf_acc_grip3";
(_this select 0) addWeapon "launch_MRAWS_sand_rail_F";
(_this select 0) addSecondaryWeaponItem "rhsusf_acc_anpeq15";
