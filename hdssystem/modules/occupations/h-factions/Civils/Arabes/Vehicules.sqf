...
_MarkerZone = createMarker [(format ["Voiture_%1",str(round (random 9999))]),(_this select 0)];
...
for "_i" from 1 to round (_Ratio + (_Taille/350)) do {
  ...
  _VehiculeCree = [_ListeRoutes,180,(SelectRandom HlisteVehiculeCivilsArabes),civilian] call bis_fnc_spawnvehicle;
