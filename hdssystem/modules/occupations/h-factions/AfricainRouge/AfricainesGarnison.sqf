...
if (_Visible isEqualto true) then {_NomMarqueur setMarkerAlpha 0.15} else {_NomMarqueur setMarkerAlpha 0.0};
...
for "_i" from 0 to (_this select 2) do {
  _Groupes = [_NomMarqueur call bis_fnc_randomPosTrigger,east,(configfile >> "CfgGroups" >> "East" >> "LOP_AFR_OPF" >> "Infantry" >> "LOP_AFR_OPF_Support_section")] call BIS_fnc_spawnGroup;
